...
ConfigFile.prototype.set = function (key, value, cb) {
...
ConfigFile.prototype.setMulti = function (multi, cb) {
...
ConfigFile.prototype.setAll = function (newconfig, cb) {
    this.conf = newconfig;
    this.save(cb);
}

ConfigFile.prototype.delete = function (key, cb) {
