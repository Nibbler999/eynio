...
function createActionLogger()
{
    ...
    bunyan.RotatingFileStream.prototype._calcRotTime = function(periodOffset) {
        var d = new Date();
        return +new Date(d.getFullYear(), d.getMonth(), d.getDate() + periodOffset);
    };
...
Logs.getActionLog = getActionLog;
